...
var encodeAvp = function(avp, appId) {
    ...
    var avpHeaderBuffer = new Buffer.alloc(avpHeaderLength);
    ...
    if (avpDataBuffer.length % 4 !== 0) {
        var filler = new Buffer.alloc(4 - avpDataBuffer.length % 4);
        filler.fill(0);
...
exports.encodeMessage = function(message) {
    var buffer = new Buffer.alloc(DIAMETER_MESSAGE_HEADER_LENGTH_IN_BYTES);
